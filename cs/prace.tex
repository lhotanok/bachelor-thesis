...
\def\KlicovaSlova{%
{webová aplikace} {recept} {znalostní graf} {propojená data} {vyhledávání}
}
\def\KlicovaSlovaEN{%
{web app} {recipe} {knowledge graph} {linked data} {search}
}
